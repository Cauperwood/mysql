...
CREATE TABLE user_music (
	id SERIAL PRIMARY KEY,
	user_song BIGINT unsigned NOT NULL,
	
	FOREIGN KEY (user_song) REFERENCES music(id)	
);

DROP TABLE IF EXISTS user_documents;
CREATE TABLE user_documents (
	id SERIAL PRIMARY KEY,
	user_document BIGINT unsigned NOT NULL,
	
	FOREIGN KEY (user_document) REFERENCES users(id)
);
